...
/*   Updated: 2022/01/28 15:16:23 by jeancarlen       ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	while (x < data->size_x / IMG_W)
	{
		...
		while (y < data->size_y / IMG_H)
		{
			if(data->map.map[y][x] == '1')
                ...
                mlx_put_image_to_window(data->mlx, data->win, data->img.ground, x * IMG_W, y * IMG_H);
            ...
            if(data->map.map[y][x] == 'E')
            {
                if(data->map.collectables > 0)
                    ...
                    mlx_put_image_to_window(data->mlx, data->win, data->img.exit_w, x * IMG_W, y * IMG_H);
            }
			y += 1;
		}
		x += 1;	
...
// esc53 up126 down125 left123 right124 w6 a12 s1 d2
